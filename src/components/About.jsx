            ...
            <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="order-1 lg:order-2">
                    ...
                    <div className="space-y-6 text-on-surface-variant body-lg leading-relaxed">
                        <p> I'm a passionate Full Stack & DevOps Engineer with deep experience in building full-scale web applications. I don't just write code; I architect ecosystems that are performant, secure, and user-centric.</p>
