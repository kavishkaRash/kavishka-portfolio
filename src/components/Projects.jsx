            ...
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="group grid grid-cols-1 lg:grid-cols-12 gap-0 bg-surface-container overflow-hidden border border-outline-variant/10">
                    ...
                    <div className="lg:col-span-7 relative h-[400px] lg:h-[600px] overflow-hidden z-10">
                        <img
                            alt="Checkmate Admission Guide homepage"
                            ...
                            src="https://res.cloudinary.com/dbnwsu3ed/image/upload/v1790104490/11111_c7nufn.png"
                        />
                    ...
                    <div className="lg:col-span-5 p-12 flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap gap-5">
                            <Link to="https://checkmateadmission.com/" class="bg-primary text-on-primary px-6 py-3 rounded-md font-bold hover:scale-105 transition-all duration-300 flex items-center gap-2" target="_blank" rel="noopener noreferrer" href="https://luxglows.netlify.app/">
                                Live <span class="material-symbols-outlined text-sm">open_in_new</span>
                            </Link>
                            <Link to="/checkmate" class="bg-surface-container-high/60 border border-outline-variant text-white px-6 py-3 rounded-md font-bold hover:bg-surface-container-highest transition-all duration-300 flex items-center gap-2" target="_blank" rel="noopener noreferrer" href="https://github.com/kavishkaRash/luxglow-ecommerce-frontend.git">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    ...
                    <div className="group bg-surface-container border border-outline-variant/10 p-8 hover:bg-surface-container-high transition-all">
                        ...
                        <h4 className="text-2xl font-bold text-white mb-3"> LuxGlow E-Commerce </h4>
